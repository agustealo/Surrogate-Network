...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      media_access_grants: {
        Row: {
          ...
          id: string
          media_id: string
          status: Database["public"]["Enums"]["media_grant_status"] | null
          to_user_id: string
        }
        Insert: {
          expires_at?: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "media_access_grants_from_user_id_fkey"
            columns: ["from_user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "media_access_grants_media_id_fkey"
            columns: ["media_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "media_access_grants_to_user_id_fkey"
            columns: ["to_user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      media_access_requests: {
        ...
        Relationships: [
          {
            foreignKeyName: "media_access_requests_from_user_id_fkey"
            columns: ["from_user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "media_access_requests_media_id_fkey"
            columns: ["media_id"]
            isOneToOne: false
            referencedRelation: "media_assets"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "media_access_requests_to_user_id_fkey"
            columns: ["to_user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      media_assets: {
        Row: {
          access_level: Database["public"]["Enums"]["media_access_level"] | null
        ...
        Insert: {
          access_level?:
            | Database["public"]["Enums"]["media_access_level"]
            | null
          alt_text?: string | null
          created_at?: string | null
          id?: string
    ...
    Enums: {
      ...
      media_access_level: "public" | "private" | "request_required"
      media_grant_status: "pending" | "granted" | "denied" | "expired"
